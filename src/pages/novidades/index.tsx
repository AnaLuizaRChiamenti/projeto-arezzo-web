...
export default function HomePDC() {
  return (
    <section className="flex items-center justify-center py-6 md:justify-start md:px-10 lg:px-16">
      <button className="flex items-center justify-center px-7 py-2 border-2 border-gray-400 rounded-full hover:bg-gray-300 transform bg-transparent md:w-36 lg:w-48 lg:h-16 xl:w-36 xl:h-12">
        <Image
          src={icon_filter}
